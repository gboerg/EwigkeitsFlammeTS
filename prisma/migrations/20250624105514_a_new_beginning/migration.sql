/*
  ...
  - You are about to alter the column `thread_initial_message` on the `Threads` table. The data in that column could be lost. The data in that column will be cast from `String` to `Int`.
